          ...
          <div className="flex justify-center gap-1 px-4">
            {otpCode.map((digit, index) => (
              <Input
                ...
                className="w-10 h-10 text-center text-lg font-semibold border-2 border-gray-300 focus:border-orange-500 focus:ring-orange-500 transition-colors shrink-0"
                disabled={isLoading}
              />
            ))}
          </div>
